...
;;
;; To run:
;;    ikarus --r6rs-script srfi/%3A101/random-access-lists/tests.sls
;;    larceny -r6rs -path . -program srfi/%3A101/random-access-lists/tests.sls
;;    plt-r6rs ++path . srfi/%3A101/random-access-lists/tests.sls
