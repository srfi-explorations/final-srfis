...
(module r6rs-reader-test mzscheme
  ...
  (test-str+sym (string (integer->char #x56)) "\\u0056")
  (test-str+sym (string (integer->char #x1256)) "\\u1256")
  (test-str+sym (string (integer->char #x1256) #\7 #\8) "\\u125678")
  (test-str+sym (string (integer->char #x00105678)) "\\U00105678")
  ...
  (test-error "#\\x000")
  (test-error "#\\u00000")
  (test-error "#\\U000000000")
  (test-error (format "#\\~az" (integer->char  #x1256)))
  ...
  (test-hex-error "\\xza")
  (test-hex-error "\\xaz")
  (test-hex-error "\\ud90x")
  (test-hex-error "\\ux90d")
  (test-hex-error "\\ud900")
